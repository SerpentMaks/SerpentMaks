...
### 🧐 Обо мне
Я студент направления **«Программная инженерия»**, выбрал качество продукта своей профессией.  
Преимущество — **понимание кода** (Java/Python): нахожу баги по логике, локализую причину, говорю с разработчиками на одном языке.

- 🔭 Ищу: **Стажировку / Junior QA**
- 🌱 Изучаю: **Автоматизацию тестирования**
- ⚡ Принцип: **«Качество — не случайность, а результат работы»**
...
- 📝 **Документация:** понятные тест-кейсы, чек-листы, баг-репорты
- 🧠 **Анализ:** нахожу «узкие места» в требованиях, приоритизирую риски
- 🎓 **Обучаемость:** регулярно беру курсы (Stepik), осваиваю новые инструменты

---

### 📚 Образование
- 🏛️ Университет: **Программная инженерия**
- 📚 Курсы на **Stepik**: разработка, тестирование, инструменты

---

<div align="center">
<sub>Открыт к стажировкам и Junior QA (Manual). Готов расти в сторону automation.</sub>
</div>
